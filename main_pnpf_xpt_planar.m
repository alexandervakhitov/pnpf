...
addpath(genpath('toolbox\upnpPlanar_codeRelease\upnpPlanar_codeRelease'))
...
markerlist = {'o-', '*-'};
for i = 1:2
    p(i) = plot(nls, vars(:,i), markerlist {i}, 'displayname',method_list(i).name);
end
