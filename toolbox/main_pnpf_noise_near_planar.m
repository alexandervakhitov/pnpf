...
name= {'HOMO', 'UPnPf+GN', 'GPnPf',   'GPnPf+GN', 'RPnP', 'EPnPfR'};
f= {   @HOMO, @upnp_GN_interface, @GPnP_f, @GPnP_f_GN, @RPnP_interface, @(x,y)pnpfmy(x,y,4,1,pnpOpts)};
marker= { 'x', 'o', '>', 's', '+','<'};
color= {'r','g', 'm','k','c','b'};
...
hold('all');
for i = 1:4
    p(i) = plot(6:15, method_list(i).mean_reproj,'marker',method_list(i).marker,...
